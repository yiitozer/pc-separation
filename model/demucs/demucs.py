...
class DConv(nn.Module):
    ...
    def __init__(self, channels: int, compress: float = 4, depth: int = 2, init: float = 1e-4,
                 ...
                 kernel=3, dilate=True, sep_conv=False):
        """
        Args:
        ...
        for d in range(self.depth):
            ...
            if sep_conv:
                mods = [SepConv(conv_type=nn.Conv1d,
                                ch_in=channels,
                                ch_out=hidden,
                                kernel_size=kernel,
                                dilation=dilation,
                ...
                mods = [nn.Conv1d(channels, hidden, kernel, dilation=dilation, padding=padding),
                        norm_fn(hidden), act(),
